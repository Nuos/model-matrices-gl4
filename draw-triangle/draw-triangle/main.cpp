...
{
    shaderLoader.load("/Users/wistoneqqx/Documents/opengl/opengl-study-records/transformation-matrices/draw-triangle/draw-triangle/simpleShader.vert",
                      "/Users/wistoneqqx/Documents/opengl/opengl-study-records/transformation-matrices/draw-triangle/draw-triangle/simpleShader.frag");
    shaderLoader.bind();
}
...
{
    GLuint uniformLoation = glGetUniformLocation(shaderLoader.getProgramID(), "rotateY");
    if(uniformLoation != -1)
    {
        glUniformMatrix4fv(uniformLoation, 1, GL_FALSE, &rotateY[0][0]);
    }
